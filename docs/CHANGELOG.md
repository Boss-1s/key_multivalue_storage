...
- [📦 v1.3.2.20260922b4 — *kms-v1.3.2/2026.09.22b4*](#-v13220260922b4--kms-v13220260922b4)
...
- [📦 v1.2.3.20260605.4b3 — *kms-v1.2.3b3/2026.06.05d*](#-v123202606054b3--kms-v123b320260605d)
- [📦 v1.2.3.20260605.4b2 — *kms-v1.2.3b2/2026.06.05d*](#-v123202606054b2--kms-v123b220260605d)
- [📦 v1.2.3.20260605.4b1 — *kms-v1.2.3b1/2026.06.05d*](#-v123202606054b1--kms-v123b120260605d)
- [📦 v1.2.3.20260605.4b0 — *kms-v1.2.3b0/2026.06.05d*](#-v123202606054b0--kms-v123b020260605d)
- [📦 v1.2.3.20260605.3 — *\[YANKED\] kms-v1.2.3/2026.06.05c*](#-v123202606053--yanked-kms-v12320260605c)
- [📦 v1.2.3.20260605.2 — *\[YANKED\] kms-v1.2.3/2026.06.05b*](#-v123202606052--yanked-kms-v12320260605b)
- [📦 v1.2.3.20260605.1 — *kms-v1.2.3/2026.06.05a*](#-v123202606051--kms-v12320260605a)
- [📦 v1.2.3.20260605 — *kms-v1.2.3/2026.06.05*](#-v12320260605--kms-v12320260605)
- [📦 v1.2.3.20260523.1 — *kms-v1.2.3/2026.05.23a*](#-v123202605231--kms-v12320260523a)
- [📦 v1.2.3.20260523 — *kms-v1.2.3/2026.05.23*](#-v12320260523--kms-v12320260523)
- [📦 v1.2.2.20260517.3 — *kms-v1.2.2/2026.05.17c*](#-v122202605173--kms-v12220260517c)
- [📦 v1.2.2.20260517.3-b — *kms-v1.2.2/2026.05.17c-beta*](#-v122202605173-b--kms-v12220260517c-beta)
- [📦 v1.2.2.20260517.2 — *kms-v1.2.2/2026.05.17b*](#-v122202605172--kms-v12220260517b)
- [📦 v1.2.2.20260517.1 — *kms-v1.2.2/2026.05.17a*](#-v122202605171--kms-v12220260517a)
- [📦 v1.2.2.20260517 — *kms-v1.2.2/2026.05.17*](#-v12220260517--kms-v12220260517)
- [📦 v1.2.2.20260515.1 — *kms-v1.2.2/2026.05.15a*](#-v122202605151--kms-v12220260515a)
...
**Full Changelog**: https://github.com/Boss-1s/key_multivalue_storage/compare/v1.3.2.20260922b4.post1...v1.3.2.20260922b4.post2

---

## 📦 v1.3.2.20260922b4.post1 — *kms-v1.3.2b4.post1/2026.09.22*

⚙ **Target Node Commit:** `6453551b`

📝 **Release Type:** Pre-release - Minor Patch

**Full Changelog**: https://github.com/Boss-1s/key_multivalue_storage/compare/v1.3.2.20260922b4.post0...v1.3.2.20260922b4.post1

---

## 📦 v1.3.2.20260922b4.post0 — *kms-v1.3.2/2026.09.22b4.post0*

⚙ **Target Node Commit:** `e2241b03`

📝 **Release Type:** Pre-release - Minor Patch

**Full Changelog**: https://github.com/Boss-1s/key_multivalue_storage/compare/v1.3.2.20260922b4...v1.3.2.20260922b4.post0

---

## 📦 v1.3.2.20260922b4 — *kms-v1.3.2/2026.09.22b4*

⚙ **Target Node Commit:** `1f8ff71d`

📝 **Release Type:** Pre-release - Minor Patch

testing release before merge

**Full Changelog**: https://github.com/Boss-1s/key_multivalue_storage/compare/v1.3.2.20260922b3...v1.3.2.20260922b4

---

## 📦 v1.3.2.20260922b3 — *kms-v1.3.2/2026.09.22b3*

⚙ **Target Node Commit:** `71c467a4`
...
* [`kms-semver1.3.x` diff](#kms-semver13x-diff)
* [`kms-v1.2.3/2026.05.23a` diff](#kms-v1232026-05-23a-diff)
* [Notes](#notes)
* [Plans for next update](#plans-for-next-update)
...
* Fixed fatal bug where warning class breaking changes was not mitigated
...
> [!important]
> **None of these are true breaking changes** - instead, all old features will *still remain in the code* carrying `DeprecationWarning`s until **kms-semver2.0**.

* **All metadata variables from `kms-semver1.2.2` was renamed.** Consider updating to `kms-v1.2.3/2026.06.05` (using `pip install key-multivalue-storage===1.2.3.20260605`) or later and changing the old names to the new ones in your code. *You can still use the old names, however they are no longer recommended for use and will display a `DeprecationWarning` warning.*
...
* In `Storage.Delete.by_propkey`: **the required argument `top_level_key` will be renamed to `top_lv_key`, to match with other methods with the same parameter. *This should not affect normal performance***, *unless* you assign the arguments like this:
```py
...
* **Production Dependencies**
    * Added `rich` as a brand new production requirement (`>=15.0.0`) to handle advanced library text output formatting and layout features.
    * Added `typing-extensions` as a brand new core development requirement, pinned to the `~=4.16` range.
* **CI/CD & GitHub Actions**
    * Upgraded pipeline environment builders `actions/setup-python`, `actions/checkout`, and `astral-sh/setup-uv` to major version `7`.
    * Incremented `reviewdog/action-actionlint` up to `1.73.0` and `oprypin/find-latest-tag` to `1.1.3`.
* **Dependency Group Isolation**
    * `test`: Enforces standard environment testing rules utilizing `pylint>=4.0.6` and `pylint-per-file-ignores`.
    * `release`: Created to separate deployment scripts with targeted tools like `md-toc` and `requests`.
    * `dev`: Acts as an umbrella group that merges `test` and `release` while pinning local workspace management.
...
* chore(deps): update typing-extensions requirement from ~=4.15 to ~=4.16 by @dependabot[bot] in https://github.com/Boss-1s/key_multivalue_storage/pull/13
...
After three months of hard, _hard work_....

...`kms-semver1.3.0` is finally out.

I cannot even being to believe that just _three months ago_, I decided to **publish an extremely messy, albeit useful, module onto PyPI**, and here I am now, _with an actual library_, containing **four main modules** and **three utility modules.**
...
**About `kms-semver1.3.1`,** the next major patch, that will come out **very soon** to address bug issues #14 and #26. If possible, I will also add the feature suggested in feat issue #27. _There is no set release date yet; however, the planned range of possible dates goes from August 5th, 2026 to August 11th, 2026._

#### Full Changelogs

* `kms-semver1.3.x` diff: https://github.com/Boss-1s/key_multivalue_storage/compare/v1.3.0.20260727rc1...v1.3.0.20260730
* `kms-v1.2.3/2026.05.23a` diff: https://github.com/Boss-1s/key_multivalue_storage/compare/v1.2.3.20260523.1...v1.3.0.20260730
